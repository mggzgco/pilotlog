...
type AircraftRowMenuProps = {
  aircraftId: string;
};

export function AircraftRowMenu({ aircraftId }: AircraftRowMenuProps) {
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          <DropdownMenu.Item asChild>
            <form action={`/api/aircraft/${aircraftId}/delete`} method="post" className="w-full">
              <button
                type="submit"
